...
Color underline = const Color(0xffffffff).withOpacity(0.3);
Color hintColor = const Color(0xfffdfdfd).withOpacity(0.3);
Color inputUnderline = const Color(0xffffffff).withOpacity(0.3);
Color inputfocusedUnderline = const Color(0xfff6f6f6);
Color topBar = const Color(0xff0a0a0a);
